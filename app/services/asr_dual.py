...
_JUDGE_SYSTEM = (
    ...
    "\n"
    "RULES:\n"
    "1. Merge at the WORD level, not at the sentence level. You can take "
    "word 1 from A, word 2 from B, word 3 from A, etc.\n"
    "2. For Arabic dialect words and Arabic grammar/morphology, prefer A.\n"
    "3. For English words, drug names, brand names, medical terms — prefer "
    "B's Latin spelling. If B also got it wrong, fix it to the correct "
    "medical spelling using your knowledge.\n"
    "4. Preserve the natural Arabic word order (typically from A).\n"
