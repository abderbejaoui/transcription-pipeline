# Correction Pipeline Evaluation — `phase1_fixes`

**Date:** 2026-06-01 20:07:09  
**Elapsed:** 44.7s  
...
| **Mean WER (corrected → gold)** | 0.2591 |
| **WER reduction (Δ)** | **+0.0713** |
| **Correction precision** | 0.0803 (33/411) |
| **Correction recall** | 0.4056 (58/143) |
| **F1 score** | 0.1340 |
| **Do-no-harm rate** | 0.7624 (77/101) |
| **Total flags (HITL)** | 151 |
| **Avg flags/record** | 0.70 |
| **Avg corrections applied/record** | 1.90 |

### WER by Language

| Language | N | WER (raw) | WER (corrected) | Δ |
|----------|---|-----------|-----------------|----|
| ar | 104 | 0.5207 | 0.3894 | +0.1313 |
| en | 97 | 0.1406 | 0.1326 | +0.0079 |
| mixed | 15 | 0.2390 | 0.1733 | +0.0657 |

### WER by Difficulty

| Difficulty | N | WER (raw) | WER (corrected) | Δ |
|------------|---|-----------|-----------------|----|
| easy | 122 | 0.1622 | 0.1350 | +0.0272 |
| hard | 33 | 0.5073 | 0.3975 | +0.1098 |
| medium | 61 | 0.5713 | 0.4325 | +0.1388 |
...
|----|------|------|----------------|---------|----------|----|---------|-------|------------|
| eval_0000 | en | medium | Yes | 0.075 | 0.226 | -0.151 | 19 | 6 | ✅ |
| eval_0001 | en | medium | Yes | 0.093 | 0.093 | +0.000 | 31 | 3 | ✅ |
| eval_0002 | en | hard | Yes | 0.065 | 0.174 | -0.109 | 15 | 6 | ✅ |
| eval_0003 | en | medium | Yes | 0.067 | 0.133 | -0.067 | 25 | 4 | ✅ |
| eval_0004 | en | hard | Yes | 0.256 | 0.282 | -0.026 | 1 | 1 | ✅ |
| eval_0005 | en | medium | Yes | 0.098 | 0.195 | -0.098 | 12 | 4 | ✅ |
| eval_0006 | en | hard | Yes | 0.143 | 0.114 | +0.029 | 8 | 4 | ✅ |
| eval_0007 | en | medium | Yes | 0.098 | 0.049 | +0.049 | 10 | 1 | ✅ |
| eval_0008 | en | hard | Yes | 0.143 | 0.114 | +0.029 | 26 | 3 | ✅ |
| eval_0009 | en | medium | Yes | 0.118 | 0.059 | +0.059 | 26 | 4 | ✅ |
| eval_0010 | en | medium | Yes | 0.129 | 0.129 | +0.000 | 0 | 0 | ✅ |
| eval_0011 | en | medium | Yes | 0.125 | 0.031 | +0.094 | 19 | 3 | ✅ |
| eval_0012 | en | hard | Yes | 0.138 | 0.138 | +0.000 | 1 | 1 | ✅ |
| eval_0013 | en | hard | Yes | 0.125 | 0.125 | +0.000 | 15 | 2 | ✅ |
| eval_0014 | en | hard | Yes | 0.029 | 0.118 | -0.088 | 3 | 3 | ✅ |
| eval_0015 | en | hard | Yes | 0.094 | 0.219 | -0.125 | 14 | 3 | ✅ |
| eval_0016 | en | hard | Yes | 0.088 | 0.088 | +0.000 | 16 | 5 | ✅ |
| eval_0017 | en | medium | No | 0.000 | 0.033 | -0.033 | 1 | 1 | ❌ |
| eval_0018 | en | medium | No | 0.000 | 0.097 | -0.097 | 3 | 3 | ❌ |
| eval_0019 | en | hard | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0020 | en | hard | No | 0.000 | 0.069 | -0.069 | 24 | 2 | ❌ |
| eval_0021 | en | hard | No | 0.000 | 0.030 | -0.030 | 1 | 1 | ❌ |
| eval_0022 | ar | medium | Yes | 0.429 | 0.286 | +0.143 | 1 | 1 | ✅ |
...
| eval_0027 | ar | medium | Yes | 0.750 | 0.750 | +0.000 | 0 | 0 | ✅ |
| eval_0028 | ar | medium | Yes | 1.000 | 0.400 | +0.600 | 3 | 1 | ✅ |
| eval_0029 | ar | medium | Yes | 1.000 | 0.500 | +0.500 | 2 | 1 | ✅ |
| eval_0030 | en | medium | Yes | 0.250 | 0.500 | -0.250 | 3 | 2 | ✅ |
| eval_0031 | en | medium | Yes | 0.333 | 0.667 | -0.333 | 2 | 2 | ✅ |
| eval_0032 | en | medium | Yes | 0.667 | 0.333 | +0.333 | 1 | 1 | ✅ |
| eval_0033 | ar | medium | Yes | 1.000 | 1.000 | +0.000 | 0 | 0 | ✅ |
| eval_0034 | ar | easy | Yes | 1.000 | 1.000 | +0.000 | 0 | 0 | ✅ |
| eval_0035 | ar | easy | Yes | 1.000 | 1.000 | +0.000 | 0 | 0 | ✅ |
...
| eval_0043 | ar | medium | Yes | 0.667 | 0.667 | +0.000 | 0 | 0 | ✅ |
| eval_0044 | ar | medium | Yes | 1.000 | 0.500 | +0.500 | 1 | 1 | ✅ |
| eval_0045 | ar | medium | Yes | 1.000 | 1.000 | +0.000 | 0 | 0 | ✅ |
...
| eval_0050 | ar | medium | Yes | 1.000 | 0.000 | +1.000 | 2 | 1 | ✅ |
| eval_0051 | ar | hard | Yes | 1.000 | 1.000 | +0.000 | 0 | 0 | ✅ |
...
| eval_0075 | ar | medium | Yes | 1.000 | 1.000 | +0.000 | 0 | 0 | ✅ |
...
| eval_0080 | ar | easy | Yes | 0.500 | 0.500 | +0.000 | 0 | 0 | ✅ |
...
| eval_0089 | en | easy | No | 0.000 | 0.167 | -0.167 | 1 | 1 | ❌ |
| eval_0090 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0091 | en | easy | No | 0.000 | 1.000 | -1.000 | 8 | 4 | ❌ |
| eval_0092 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0093 | en | easy | No | 0.000 | 0.333 | -0.333 | 9 | 2 | ❌ |
| eval_0094 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0095 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0096 | en | easy | No | 0.000 | 0.167 | -0.167 | 2 | 2 | ❌ |
| eval_0097 | en | easy | No | 0.000 | 0.300 | -0.300 | 3 | 2 | ❌ |
| eval_0098 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0099 | en | easy | No | 0.000 | 0.400 | -0.400 | 4 | 1 | ❌ |
| eval_0100 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0101 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0102 | en | easy | No | 0.000 | 0.200 | -0.200 | 1 | 1 | ❌ |
...
| eval_0109 | en | easy | No | 0.000 | 0.182 | -0.182 | 2 | 2 | ❌ |
...
| eval_0113 | en | easy | No | 0.000 | 0.100 | -0.100 | 1 | 1 | ❌ |
| eval_0114 | en | easy | No | 0.000 | 0.200 | -0.200 | 2 | 1 | ❌ |
| eval_0115 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0116 | en | easy | No | 0.000 | 0.111 | -0.111 | 1 | 1 | ❌ |
| eval_0117 | en | easy | No | 0.000 | 0.100 | -0.100 | 1 | 1 | ❌ |
| eval_0118 | en | easy | No | 0.000 | 0.100 | -0.100 | 1 | 1 | ❌ |
| eval_0119 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0120 | en | easy | No | 0.000 | 0.143 | -0.143 | 1 | 1 | ❌ |
| eval_0121 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0122 | en | easy | No | 0.000 | 0.111 | -0.111 | 1 | 1 | ❌ |
...
| eval_0129 | en | easy | No | 0.000 | 0.182 | -0.182 | 5 | 1 | ❌ |
...
| eval_0139 | ar | easy | No | 0.000 | 0.286 | -0.286 | 2 | 1 | ❌ |
...
| eval_0179 | mixed | hard | Yes | 0.400 | 0.400 | +0.000 | 0 | 0 | ✅ |
| eval_0180 | mixed | medium | Yes | 0.250 | 0.500 | -0.250 | 3 | 2 | ✅ |
| eval_0181 | mixed | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0182 | mixed | hard | Yes | 0.286 | 0.286 | +0.000 | 7 | 2 | ✅ |
| eval_0183 | mixed | medium | Yes | 0.250 | 0.000 | +0.250 | 1 | 1 | ✅ |
| eval_0184 | mixed | medium | Yes | 0.286 | 0.286 | +0.000 | 2 | 2 | ✅ |
...
| eval_0188 | mixed | hard | Yes | 0.286 | 0.286 | +0.000 | 0 | 0 | ✅ |
| eval_0189 | mixed | medium | Yes | 0.250 | 0.250 | +0.000 | 0 | 0 | ✅ |
| eval_0190 | mixed | medium | Yes | 0.250 | 0.000 | +0.250 | 1 | 1 | ✅ |
| eval_0191 | mixed | hard | Yes | 0.500 | 0.250 | +0.250 | 1 | 1 | ✅ |
| eval_0192 | mixed | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0193 | mixed | hard | Yes | 0.429 | 0.143 | +0.286 | 3 | 2 | ✅ |
| eval_0194 | en | medium | Yes | 0.167 | 0.333 | -0.167 | 3 | 2 | ✅ |
...
| eval_0199 | en | medium | Yes | 0.400 | 0.400 | +0.000 | 2 | 2 | ✅ |
...
| eval_0210 | en | medium | Yes | 0.250 | 0.250 | +0.000 | 1 | 1 | ✅ |
...
| eval_0215 | en | hard | Yes | 0.333 | 0.500 | -0.167 | 1 | 1 | ✅ |

---

## Failure Cases

**24 false positives (changes to clean input):**

- **eval_0089**: 'Vital'→'vital'
- **eval_0021**: 'biopsy'→'Biobsy'
- **eval_0109**: 'Review'→'naltrexone', 'sweats.'→'saturation.'
- **eval_0099**: 'Physical'→'physical', 'examination'→'reveals', 'reveals'→'no', 'no'→'abnormalities.'
- **eval_0113**: 'does'→'doses'
- **eval_0120**: 'status'→'saturation'
- **eval_0102**: 'Continue'→'continue'
- **eval_0122**: 'follow'→'influenza'
- **eval_0105**: 'or'→'shortness', 'shortness'→'of', 'of'→'breath.'
- **eval_0118**: 'infection.'→'hiv'
- **eval_0018**: 'continuing'→'continue', 'disease'→'doses', 'team'→'diabetes'
- **eval_0093**: 'Please'→'heart', 'follow'→'rate', 'up'→'influenza', 'in'→'up', 'the'→'in', 'clinic'→'the', 'in'→'clinic', '2'→'in', 'weeks.'→'2'
- **eval_0116**: 'treatment'→'therapy'
- **eval_0169**: 'الجرعة'→'الجرعه'
- **eval_0017**: 'team'→'diabetes'
- **eval_0147**: 'نظيف'→'نزيف'
- **eval_0020**: 'biopsy'→'Biobsy', 'promyelocytic'→'acute', 'leukemia,'→'promyelocytic', 'and'→'leukemia,', 'hematology'→'and', 'has'→'hematology', 'already'→'has', 'started'→'already', 'all-trans'→'started', 'retinoic'→'all-trans', 'acid.'→'retinoic', 'Because'→'acid.', 'of'→'Because', 'the'→'of', 'coagulopathy'→'the', 'risk,'→'coagulopathy', 'the'→'risk,', 'patient'→'the', 'will'→'patient', 'remain'→'will', 'in'→'remain', 'a'→'in', 'monitored'→'a', 'setting.'→'monitored'
- **eval_0096**: 'clean'→'verapamil', 'infection.'→'hiv'
- **eval_0117**: 'department'→'therapy'
- **eval_0091**: 'BP'→'blood', '120/80'→'pressure', 'HR'→'120/80', '72'→'heart', 'Temp'→'rate', '37.2'→'72', 'RR'→'temperature', '16'→'rheumatoid'
- **eval_0097**: 'place,'→'heart', 'and'→'rate,', 'time.'→'and'
- **eval_0114**: 'exam'→'is', 'is'→'unremarkable.'
- **eval_0129**: 'here'→'heart', 'for'→'rate', 'a'→'for', 'routine'→'a', 'physical.'→'routine'
- **eval_0139**: 'غدا'→'chest', 'إن'→'pain'

**79 records with missed corrections:**

- **eval_0030** (lang=en, diff=medium)
  - Gold: 'clopidogr 75 mg daily'→'clopidogrel 75 mg daily'
  - Changes applied: 'clopidogr'→'clopidogrel', '75'→'myasthenia', 'mg'→'gravis'
