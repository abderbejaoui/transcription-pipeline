# Correction Pipeline Evaluation — `phase1_fixes_v2`

**Date:** 2026-06-01 20:08:26  
**Elapsed:** 45.6s  
...
| **Mean WER (corrected → gold)** | 0.2339 |
| **WER reduction (Δ)** | **+0.0965** |
| **Correction precision** | 0.0930 (40/430) |
| **Correction recall** | 0.4615 (66/143) |
| **F1 score** | 0.1548 |
| **Do-no-harm rate** | 0.7525 (76/101) |
| **Total flags (HITL)** | 170 |
| **Avg flags/record** | 0.79 |
| **Avg corrections applied/record** | 1.99 |

### WER by Language

| Language | N | WER (raw) | WER (corrected) | Δ |
|----------|---|-----------|-----------------|----|
| ar | 104 | 0.5207 | 0.3471 | +0.1736 |
| en | 97 | 0.1406 | 0.1326 | +0.0079 |
| mixed | 15 | 0.2390 | 0.1038 | +0.1352 |

### WER by Difficulty

| Difficulty | N | WER (raw) | WER (corrected) | Δ |
|------------|---|-----------|-----------------|----|
| easy | 122 | 0.1622 | 0.1202 | +0.0420 |
| hard | 33 | 0.5073 | 0.3411 | +0.1662 |
| medium | 61 | 0.5713 | 0.4033 | +0.1681 |
...
| eval_0033 | ar | medium | Yes | 1.000 | 0.667 | +0.333 | 1 | 1 | ✅ |
...
| eval_0056 | ar | hard | Yes | 1.000 | 0.667 | +0.333 | 1 | 1 | ✅ |
...
**25 false positives (changes to clean input):**
...
**73 records with missed corrections:**
