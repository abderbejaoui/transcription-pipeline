# Correction Pipeline Evaluation — `after_stage2_v2`

**Date:** 2026-06-01 23:14:05  
**Elapsed:** 70.6s  
...
| **Mean WER (corrected → gold)** | 0.2546 |
| **WER reduction (Δ)** | **+0.0758** |
| **Correction precision** | 0.9020 (46/51) |
| **Correction recall** | 0.2587 (37/143) |
| **F1 score** | 0.4021 |
| **Do-no-harm rate (all records)** | 0.9815 (212/216) |
| **Do-no-harm rate (clean only)** | 0.9901 (100/101) |
| **Harmful changes (total)** | 4 (in 4 records) |
| **Missed errors — flagged for HITL** | 50 |
| **Missed errors — silently passed** | 56 |
| **Total flags (HITL)** | 99 |
| **Avg flags/record** | 0.46 |
| **Avg corrections applied/record** | 0.24 |

### WER by Language

| Language | N | WER (raw) | WER (corrected) | Δ |
|----------|---|-----------|-----------------|----|
| ar | 104 | 0.5207 | 0.4514 | +0.0693 |
| en | 97 | 0.1406 | 0.0682 | +0.0724 |
| mixed | 15 | 0.2390 | 0.0967 | +0.1424 |

### WER by Difficulty

| Difficulty | N | WER (raw) | WER (corrected) | Δ |
|------------|---|-----------|-----------------|----|
| easy | 122 | 0.1622 | 0.0969 | +0.0653 |
| hard | 33 | 0.5073 | 0.4321 | +0.0752 |
| medium | 61 | 0.5713 | 0.4742 | +0.0971 |
...
**4 records with harmful changes (a token gold says should stay was changed):**
...
**91 records with missed corrections:**
