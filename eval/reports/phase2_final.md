# Correction Pipeline Evaluation — `phase2_final`

**Date:** 2026-06-01 20:29:19  
**Elapsed:** 50.5s  
...
| **Mean WER (corrected → gold)** | 0.2275 |
| **WER reduction (Δ)** | **+0.1029** |
| **Correction precision** | 0.1242 (38/306) |
| **Correction recall** | 0.4126 (59/143) |
| **F1 score** | 0.1909 |
| **Do-no-harm rate** | 0.9307 (94/101) |
| **Total flags (HITL)** | 128 |
| **Avg flags/record** | 0.59 |
| **Avg corrections applied/record** | 1.41 |

### WER by Language

| Language | N | WER (raw) | WER (corrected) | Δ |
|----------|---|-----------|-----------------|----|
| ar | 104 | 0.5207 | 0.3572 | +0.1635 |
