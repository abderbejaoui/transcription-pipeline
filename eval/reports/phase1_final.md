# Correction Pipeline Evaluation — `phase1_final`

**Date:** 2026-06-01 20:15:10  
**Elapsed:** 43.9s  
...
| **Mean WER (corrected → gold)** | 0.2364 |
| **WER reduction (Δ)** | **+0.0941** |
| **Correction precision** | 0.1022 (37/362) |
| **Correction recall** | 0.4126 (59/143) |
| **F1 score** | 0.1638 |
| **Do-no-harm rate** | 0.8218 (83/101) |
| **Total flags (HITL)** | 163 |
| **Avg flags/record** | 0.75 |
| **Avg corrections applied/record** | 1.66 |
...
|------------|---|-----------|-----------------|----|
| easy | 122 | 0.1622 | 0.1108 | +0.0514 |
| hard | 33 | 0.5073 | 0.3425 | +0.1648 |
| medium | 61 | 0.5713 | 0.4302 | +0.1411 |
...
| eval_0003 | en | medium | Yes | 0.067 | 0.089 | -0.022 | 24 | 4 | ✅ |
| eval_0004 | en | hard | Yes | 0.256 | 0.282 | -0.026 | 1 | 1 | ✅ |
| eval_0005 | en | medium | Yes | 0.098 | 0.171 | -0.073 | 12 | 4 | ✅ |
| eval_0006 | en | hard | Yes | 0.143 | 0.057 | +0.086 | 9 | 3 | ✅ |
| eval_0007 | en | medium | Yes | 0.098 | 0.024 | +0.073 | 9 | 1 | ✅ |
...
| eval_0105 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
...
| eval_0196 | en | medium | Yes | 0.200 | 0.000 | +0.200 | 1 | 1 | ✅ |
...
**18 false positives (changes to clean input):**
