# Correction Pipeline Evaluation — `phase2d_vector_rescue_v2`

**Date:** 2026-06-01 20:45:09  
**Elapsed:** 50.4s  
...
| **Mean WER (corrected → gold)** | 0.2252 |
| **WER reduction (Δ)** | **+0.1052** |
| **Correction precision** | 0.1254 (39/311) |
...
| medium | 61 | 0.5713 | 0.4173 | +0.1540 |
