# Correction Pipeline Evaluation — `phase1_final_v2`

**Date:** 2026-06-01 20:17:08  
**Elapsed:** 38.4s  
...
| **Mean WER (corrected → gold)** | 0.2290 |
| **WER reduction (Δ)** | **+0.1014** |
| **Correction precision** | 0.1238 (38/307) |
| **Correction recall** | 0.4126 (59/143) |
| **F1 score** | 0.1904 |
| **Do-no-harm rate** | 0.9208 (93/101) |
| **Total flags (HITL)** | 129 |
| **Avg flags/record** | 0.60 |
| **Avg corrections applied/record** | 1.42 |
...
|------------|---|-----------|-----------------|----|
| easy | 122 | 0.1622 | 0.0978 | +0.0643 |
| hard | 33 | 0.5073 | 0.3360 | +0.1713 |
| medium | 61 | 0.5713 | 0.4337 | +0.1376 |
...
**8 false positives (changes to clean input):**
