# Correction Pipeline Evaluation — `phase3_safety_fix`

**Date:** 2026-06-01 22:14:47  
**Elapsed:** 64.2s  
...
| **Mean WER (corrected → gold)** | 0.2714 |
| **WER reduction (Δ)** | **+0.0590** |
| **Correction precision** | 0.2520 (31/123) |
| **Correction recall** | 0.2517 (36/143) |
| **F1 score** | 0.2519 |
| **Do-no-harm rate** | 0.9802 (99/101) |
| **Total flags (HITL)** | 133 |
| **Avg flags/record** | 0.62 |
| **Avg corrections applied/record** | 0.57 |

### WER by Language

| Language | N | WER (raw) | WER (corrected) | Δ |
|----------|---|-----------|-----------------|----|
| ar | 104 | 0.5207 | 0.4592 | +0.0616 |
| en | 97 | 0.1406 | 0.0894 | +0.0512 |
| mixed | 15 | 0.2390 | 0.1467 | +0.0924 |

### WER by Difficulty

| Difficulty | N | WER (raw) | WER (corrected) | Δ |
|------------|---|-----------|-----------------|----|
| easy | 122 | 0.1622 | 0.0982 | +0.0639 |
| hard | 33 | 0.5073 | 0.4528 | +0.0545 |
| medium | 61 | 0.5713 | 0.5196 | +0.0517 |
...
| eval_0002 | en | hard | Yes | 0.065 | 0.087 | -0.022 | 12 | 4 | ✅ |
| eval_0003 | en | medium | Yes | 0.067 | 0.089 | -0.022 | 1 | 2 | ✅ |
| eval_0004 | en | hard | Yes | 0.256 | 0.282 | -0.026 | 1 | 1 | ✅ |
| eval_0005 | en | medium | Yes | 0.098 | 0.171 | -0.073 | 12 | 3 | ✅ |
| eval_0006 | en | hard | Yes | 0.143 | 0.143 | +0.000 | 2 | 4 | ✅ |
| eval_0007 | en | medium | Yes | 0.098 | 0.098 | +0.000 | 0 | 1 | ✅ |
| eval_0008 | en | hard | Yes | 0.143 | 0.171 | -0.029 | 1 | 2 | ✅ |
| eval_0009 | en | medium | Yes | 0.118 | 0.118 | +0.000 | 0 | 3 | ✅ |
| eval_0010 | en | medium | Yes | 0.129 | 0.129 | +0.000 | 0 | 0 | ✅ |
| eval_0011 | en | medium | Yes | 0.125 | 0.125 | +0.000 | 0 | 3 | ✅ |
| eval_0012 | en | hard | Yes | 0.138 | 0.138 | +0.000 | 0 | 1 | ✅ |
| eval_0013 | en | hard | Yes | 0.125 | 0.219 | -0.094 | 21 | 2 | ✅ |
| eval_0014 | en | hard | Yes | 0.029 | 0.059 | -0.029 | 1 | 2 | ✅ |
| eval_0015 | en | hard | Yes | 0.094 | 0.125 | -0.031 | 1 | 2 | ✅ |
| eval_0016 | en | hard | Yes | 0.088 | 0.118 | -0.029 | 3 | 4 | ✅ |
...
| eval_0022 | ar | medium | Yes | 0.429 | 0.143 | +0.286 | 2 | 3 | ✅ |
...
| eval_0029 | ar | medium | Yes | 1.000 | 1.000 | +0.000 | 0 | 1 | ✅ |
...
| eval_0044 | ar | medium | Yes | 1.000 | 1.000 | +0.000 | 0 | 1 | ✅ |
...
| eval_0051 | ar | hard | Yes | 1.000 | 1.000 | +0.000 | 0 | 1 | ✅ |
...
| eval_0057 | ar | medium | Yes | 1.000 | 1.000 | +0.000 | 0 | 1 | ✅ |
| eval_0058 | ar | hard | Yes | 1.000 | 1.000 | +0.000 | 0 | 1 | ✅ |
| eval_0059 | ar | hard | Yes | 1.000 | 0.667 | +0.333 | 2 | 3 | ✅ |
...
| eval_0063 | ar | hard | Yes | 0.833 | 0.833 | +0.000 | 0 | 1 | ✅ |
...
| eval_0069 | ar | hard | Yes | 1.000 | 1.000 | +0.000 | 0 | 1 | ✅ |
...
| eval_0091 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 2 | ✅ |
...
| eval_0212 | en | medium | Yes | 0.200 | 0.000 | +0.200 | 1 | 2 | ✅ |
...
**2 false positives (changes to clean input):**

- **eval_0176**: 'المفاصل'→'myofascial'
- **eval_0018**: 'disease'→'doses'

**92 records with missed corrections:**
...
- **eval_0013** (lang=en, diff=hard)
  ...
  - Changes applied: 'cell'→'systemic', 'arteritus.'→'lupus', 'Because'→'erythematosus', 'of'→'arteritus.', 'the'→'Because', 'risk'→'of', 'of'→'the', 'vision'→'risk', 'loss,'→'of', 'we'→'vision', 'should'→'loss,', 'begin'→'we', 'predni'→'should', 'and'→'begin', 'sone'→'predni', 'today'→'and', 'and'→'sone', 'arrange'→'today', 'temporal'→'and', 'artery'→'arrange', 'evaluation.'→'temporal'
