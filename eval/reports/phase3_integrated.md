# Correction Pipeline Evaluation — `phase3_integrated`

**Date:** 2026-06-01 21:47:18  
**Elapsed:** 65.7s  
...
| **Mean WER (corrected → gold)** | 0.2542 |
| **WER reduction (Δ)** | **+0.0763** |
| **Correction precision** | 0.2429 (34/140) |
| **Correction recall** | 0.2867 (41/143) |
| **F1 score** | 0.2630 |
| **Do-no-harm rate** | 0.9604 (97/101) |
| **Total flags (HITL)** | 133 |
| **Avg flags/record** | 0.62 |
| **Avg corrections applied/record** | 0.65 |

### WER by Language

| Language | N | WER (raw) | WER (corrected) | Δ |
|----------|---|-----------|-----------------|----|
| ar | 104 | 0.5207 | 0.4209 | +0.0998 |
| en | 97 | 0.1406 | 0.0920 | +0.0486 |
...
|------------|---|-----------|-----------------|----|
| easy | 122 | 0.1622 | 0.0839 | +0.0782 |
| hard | 33 | 0.5073 | 0.4553 | +0.0520 |
| medium | 61 | 0.5713 | 0.4858 | +0.0855 |
...
|----|------|------|----------------|---------|----------|----|---------|-------|------------|
| eval_0000 | en | medium | Yes | 0.075 | 0.170 | -0.094 | 16 | 4 | ✅ |
| eval_0001 | en | medium | Yes | 0.093 | 0.116 | -0.023 | 1 | 2 | ✅ |
| eval_0002 | en | hard | Yes | 0.065 | 0.109 | -0.043 | 13 | 4 | ✅ |
...
| eval_0009 | en | medium | Yes | 0.118 | 0.147 | -0.029 | 1 | 3 | ✅ |
| eval_0010 | en | medium | Yes | 0.129 | 0.129 | +0.000 | 0 | 0 | ✅ |
| eval_0011 | en | medium | Yes | 0.125 | 0.156 | -0.031 | 1 | 3 | ✅ |
...
| eval_0109 | en | easy | No | 0.000 | 0.091 | -0.091 | 1 | 1 | ❌ |
...
**4 false positives (changes to clean input):**

- **eval_0109**: 'sweats.'→'saturation.'
