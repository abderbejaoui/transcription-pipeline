# Correction Pipeline Evaluation — `after_stage2_fix`

**Date:** 2026-06-01 23:10:56  
**Elapsed:** 71.1s  
...
| **Mean WER (corrected → gold)** | 0.2398 |
| **WER reduction (Δ)** | **+0.0906** |
| **Correction precision** | 0.7903 (49/62) |
| **Correction recall** | 0.2727 (39/143) |
| **F1 score** | 0.4055 |
| **Do-no-harm rate (all records)** | 0.9630 (208/216) |
| **Do-no-harm rate (clean only)** | 0.9604 (97/101) |
| **Harmful changes (total)** | 9 (in 8 records) |
| **Missed errors — flagged for HITL** | 52 |
| **Missed errors — silently passed** | 52 |
| **Total flags (HITL)** | 112 |
| **Avg flags/record** | 0.52 |
| **Avg corrections applied/record** | 0.29 |

### WER by Language

| Language | N | WER (raw) | WER (corrected) | Δ |
|----------|---|-----------|-----------------|----|
| ar | 104 | 0.5207 | 0.4187 | +0.1020 |
| en | 97 | 0.1406 | 0.0682 | +0.0724 |
| mixed | 15 | 0.2390 | 0.1100 | +0.1290 |

### WER by Difficulty

| Difficulty | N | WER (raw) | WER (corrected) | Δ |
|------------|---|-----------|-----------------|----|
| easy | 122 | 0.1622 | 0.0949 | +0.0672 |
| hard | 33 | 0.5073 | 0.3826 | +0.1247 |
...
| eval_0146 | ar | easy | No | 0.000 | 0.167 | -0.167 | 1 | 1 | ❌ |
...
**8 records with harmful changes (a token gold says should stay was changed):**
...
- **eval_0146** (clean, ar): 'سيتم'→'asthma'
- **eval_0150** (clean, ar): 'سيتم'→'asthma'
- **eval_0162** (clean, ar): 'التحاليل'→'sotalol', 'المعدل'→'methylprednisolone'
- **eval_0176** (clean, ar): 'المفاصل'→'myofascial'
- **eval_0185** (had-error, mixed): 'ريزلتس'→'results'

**89 records with missed corrections:**
