# Correction Pipeline Evaluation — `phase1_v3`

**Date:** 2026-06-01 20:12:36  
**Elapsed:** 44.5s  
...
| **Mean WER (corrected → gold)** | 0.2432 |
| **WER reduction (Δ)** | **+0.0872** |
| **Correction precision** | 0.0900 (35/389) |
| **Correction recall** | 0.4126 (59/143) |
| **F1 score** | 0.1477 |
| **Do-no-harm rate** | 0.8119 (82/101) |
| **Total flags (HITL)** | 170 |
| **Avg flags/record** | 0.79 |
| **Avg corrections applied/record** | 1.78 |

### WER by Language

| Language | N | WER (raw) | WER (corrected) | Δ |
|----------|---|-----------|-----------------|----|
| ar | 104 | 0.5207 | 0.3604 | +0.1603 |
| en | 97 | 0.1406 | 0.1288 | +0.0117 |
| mixed | 15 | 0.2390 | 0.1705 | +0.0686 |

### WER by Difficulty

| Difficulty | N | WER (raw) | WER (corrected) | Δ |
|------------|---|-----------|-----------------|----|
| easy | 122 | 0.1622 | 0.1136 | +0.0485 |
| hard | 33 | 0.5073 | 0.3529 | +0.1545 |
| medium | 61 | 0.5713 | 0.4431 | +0.1282 |
...
|----|------|------|----------------|---------|----------|----|---------|-------|------------|
| eval_0000 | en | medium | Yes | 0.075 | 0.189 | -0.113 | 17 | 6 | ✅ |
| eval_0001 | en | medium | Yes | 0.093 | 0.140 | -0.047 | 2 | 3 | ✅ |
| eval_0002 | en | hard | Yes | 0.065 | 0.174 | -0.109 | 15 | 6 | ✅ |
| eval_0003 | en | medium | Yes | 0.067 | 0.111 | -0.044 | 36 | 4 | ✅ |
| eval_0004 | en | hard | Yes | 0.256 | 0.282 | -0.026 | 1 | 1 | ✅ |
| eval_0005 | en | medium | Yes | 0.098 | 0.171 | -0.073 | 12 | 4 | ✅ |
...
| eval_0016 | en | hard | Yes | 0.088 | 0.059 | +0.029 | 15 | 5 | ✅ |
...
| eval_0089 | en | easy | No | 0.000 | 0.167 | -0.167 | 0 | 1 | ✅ |
...
| eval_0096 | en | easy | No | 0.000 | 0.083 | -0.083 | 1 | 2 | ❌ |
...
| eval_0102 | en | easy | No | 0.000 | 0.200 | -0.200 | 0 | 1 | ✅ |
...
| eval_0109 | en | easy | No | 0.000 | 0.091 | -0.091 | 1 | 2 | ❌ |
...
| eval_0117 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 1 | ✅ |
| eval_0118 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 1 | ✅ |
| eval_0119 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 0 | ✅ |
| eval_0120 | en | easy | No | 0.000 | 0.000 | +0.000 | 0 | 1 | ✅ |
...
| eval_0180 | mixed | medium | Yes | 0.250 | 0.750 | -0.500 | 1 | 2 | ✅ |
...
| eval_0184 | mixed | medium | Yes | 0.286 | 0.286 | +0.000 | 1 | 2 | ✅ |
...
| eval_0199 | en | medium | Yes | 0.400 | 0.400 | +0.000 | 1 | 2 | ✅ |
...
| eval_0215 | en | hard | Yes | 0.333 | 0.333 | +0.000 | 0 | 1 | ✅ |

---

## Failure Cases

**19 false positives (changes to clean input):**

- **eval_0021**: 'biopsy'→'Biobsy'
- **eval_0109**: 'Review'→'naltrexone'
