...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fine-tune Qwen3-ASR on Gulf Arabic WAVs")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs/qwen3-asr"))
