...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fine-tune VibeVoice-ASR on Gulf Arabic WAVs")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs/vibevoice-asr"))
