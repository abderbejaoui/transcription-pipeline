...
def main() -> int:
    parser = argparse.ArgumentParser(description="Download sample clips from WorldSpeech Kuwait Arabic.")
    add_common_args(parser, "worldspeech_kuwait")
    ...
    return sample_hf_dataset(
        ...
        title="WorldSpeech Arabic Kuwait",
