...
MODEL_ID = "facebook/omniASR-LLM-7B"


def main() -> None:
    parser = argparse.ArgumentParser(description="Fine-tune omniASR-LLM-7B on Gulf Arabic WAVs")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs/omni-asr"))
